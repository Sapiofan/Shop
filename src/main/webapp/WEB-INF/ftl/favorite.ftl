...
<div id="likes" class="modal-likes">
    <form id='favform' class="likes-content" action="/updateFavorites" method="get">
                    ...
                    <#if favoriteProducts?has_content>
                        <#list favoriteProducts as product>
                            ...
                            <div class="wishlist-product">
                                <a href="/product/${product.id}"><img width="150px" height="150px"
                                                                      src="${product.image}"></a>
                                ...
                                <button type="button" onclick="productChanges('/deleteFavorite/${product.id}')"
        ...
        <div class="clearfix-likes">
            <button type="button" onclick="ajax()" class="clean-button" id="clean-button" name="clean">Clear wishlist
            </button>
        </div>
    </form>
</div>
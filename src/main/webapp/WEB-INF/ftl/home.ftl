...
<main>
    ...
    <section id="best-sellers">
        <div class="sellers-padding">
            <h1>Best sellers</h1>
            <div class="products">
                <#list bestsellers as bestseller>
                    <div class="product">
                        ...
                        <div class="prices">
                            <#if bestseller.discount != 0>
                                ...
                                <#assign result = (bestseller.price-(bestseller.price*bestseller.discount/100))>
                                <p>${result?round}</p>
                            </#if>
                            <#if bestseller.discount == 0>
